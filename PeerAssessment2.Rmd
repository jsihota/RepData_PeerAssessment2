...
fatal10 <- fatal[order(-fatal$FATALITIES), ][1:20, ]
# get top10 event with highest injuries
injury10 <- injury[order(-injury$INJURIES), ][1:20, ]
...
propdmg10 <- propdmg[order(-propdmg$PROPDMGVAL), ][1:20, ]
# get top 10 events with highest crop damage
cropdmg10 <- cropdmg[order(-cropdmg$CROPDMGVAL), ][1:20, ]
par(mfrow = c(1, 2), mar = c(12, 4, 3, 2), mgp = c(3, 1, 0), cex = 0.8)
